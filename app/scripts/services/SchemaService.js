(function (angular) {
    ...
    s.service('SchemaService', ['$http', '$q', 'appConfig', 'lodash', 'spahql','Utility', function ($http, $q, appConfig, _, spahql,Utility) {
        ...
        $q.all([p1, p2, p3,p4]).then(function (data) {
